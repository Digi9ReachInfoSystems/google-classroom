...
const courseUpdates: CourseUpdate[] = [
  {
    ...
    score: "N/A",
    dateOfSubmission: "N/A",
    status: "completed",
  },
  {
    module: "Assignment -1",
    score: "88%",
    dateOfSubmission: "Sep 1, 2025",
    status: "completed",
  },
  {
    module: "Video module -2",
    score: "N/A",
    dateOfSubmission: "N/A",
    status: "pending",
  },
  ...
  },
  {
    module: "Assignment -3",
    score: "90%",
    dateOfSubmission: "Sep 10, 2025",
    status: "pending",
  },
  {
    module: "Video module -4",
    score: "N/A",
    dateOfSubmission: "N/A",
    status: "completed",
  },
          ...
          <table className="w-full table-fixed rounded-t-lg overflow-hidden border-collapse border-b border-neutral-200">
            ...
            <thead>
              <tr className="bg-[#F1F5F6]">
                <th
                  scope="col"
                  className="px-6 py-3 text-left text-sm font-medium text-neutral-600 border-0 rounded-tl-lg capitalize"
                >
                  Module/Quiz
                </th>
                <th
                  scope="col"
                  className="px-6 py-3 text-left text-sm font-medium text-neutral-600 border-0 capitalize"
                >
                  Score
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="px-6 py-3 text-left text-sm font-medium text-neutral-600 border-0 rounded-tr-lg capitalize"
                >
                  Status
                </th>
              </tr>
