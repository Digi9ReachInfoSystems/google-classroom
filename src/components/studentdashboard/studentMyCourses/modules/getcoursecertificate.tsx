  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="w-full flex justify-center">
        <div className="max-w-[720px] xl:max-w-[800px] w-full">
          <div className="w-full flex justify-center">
            <Image
          ...
          <div className="mt-6 text-center">
            ...
            <div className="mt-6">
              <button
                className="px-6 py-2 rounded-full bg-orange-400 text-white text-sm font-medium shadow hover:bg-orange-500 transition-colors"
              >
