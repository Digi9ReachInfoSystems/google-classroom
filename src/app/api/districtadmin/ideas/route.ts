...
export async function GET(req: NextRequest) {
  try {
    ...
    const dbStudents = await UserModel.find(studentQuery).select('email fullName givenName familyName schoolName');
    ...
    console.error('District admin ideas API error:', error);
    return NextResponse.json({
      success: false,
